document.addEventListener("DOMContentLoaded", () => {
            ...
            .then(data => {
                ...
                rides
                    ...
                    .forEach(ride => {
                        ...
                        ride.passengers = ride.passengers.filter(p => p.userId !== driverId);
    ...
    // --- Mark as Done button dynamically
   ...
   button.addEventListener("click", () => {
    ...
    // Send as an array, even if only one
    ...
    .then(result => {
        if (result.ok) {
            ...
            document.querySelector(`[data-target="day-${dateKey}"]`)?.remove();
            div.remove();
        } else {
    ...
    function assignClicks() {
        document.querySelectorAll(".schedule-card").forEach(card => {
            card.addEventListener("click", () => {
                ...
                document.querySelectorAll(".content-window").forEach(w => w.classList.remove("active"));
